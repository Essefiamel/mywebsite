				...
				<div class="col-md-7 text-left">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeInUp">
							...
							<p>
								 <em class="or">You have an Account</em> 
								 <br>
								<a href="log_in.php" target="_blank" class="btn btn-primary">Log In</a> 
							</p>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row row-pb-md">
				<form method="Get" action="insertuser.php">
					...
					<div  data-validate = "Firstname is required">
							<input class="form-control" type="text" name="Firstname" placeholder="firstname" id="first">
							<span class="focus-input100"></span>
						</div>

							<div  data-validate = "Lastname is required">
							<input class="form-control" type="text" name="Lastname" placeholder="lastname" id="last">
							<span class="focus-input100"></span>
						</div>
					...
					<div class="form-group">
							<input type="submit" value="Creat An Account" class="btn btn-lg btn-primary">
						</div>
